        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <a href="/admin/roles/create" style="float: right;" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"> 添加</span></a>
                ...
                columnDefs: [
                    {
                        'targets': -1, "render": function (data, type, row) {
                            ...
                            caozuo += '<a href="/admin/roles/edit/'+row['id']+'" class="X-Small btn-xs text-primary ">修改</a>';
                            caozuo += '| <a href="/admin/roles/destroy/'+row['id']+'" class="X-Small btn-xs text-primary ">删除</a>'
                            return caozuo;
                        }
                    }
                ]
