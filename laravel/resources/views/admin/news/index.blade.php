        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <a href="/admin/news/create" style="float: right;" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"> 添加</span></a>
                ...
                columnDefs: [
                    {
                        'targets': -1, "render": function (data, type, row) {
                            ...
                            caozuo += '<a href="/admin/news/edit/'+row['id']+'" class="X-Small btn-xs text-primary ">修改</a>';
                            caozuo += '| <a href="/admin/news/destroy/'+row['id']+'" class="X-Small btn-xs text-primary ">删除</a>'
                            return caozuo;
                        }
                    }
                ]
