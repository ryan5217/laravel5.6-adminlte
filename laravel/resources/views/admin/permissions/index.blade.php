        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <a href="/admin/permissions/create/{{$pid}}" style="float: right;" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"> 添加</span></a>
    ...
    <script>
        $(function () {
            var table = $("#tags-table").DataTable({
                ...
                searching: false,
                ajax: {
                    url: '/admin/permissions/index/{{$pid}}',
                    type: 'POST',
                    headers: {
                ...
                columns: [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            // console.log(data);
                            // if (row['img_path']){
                                return '<input type="checkbox"  class="checkchild"  name="id" value="' + data + '" />';
                ...
                columnDefs: [
                    {
                        'targets': -1, "render": function (data, type, row) {
                            ...
                            if (row['pid'] == 0) {
                                caozuo += '<a href="/admin/permissions/index/'+row['id']+'" class="X-Small btn-xs text-primary ">添加下级菜单</a> |';
                            }
                            caozuo += '<a href="/admin/permissions/edit/'+row['id']+'" class="X-Small btn-xs text-primary ">修改</a>';
                            caozuo += '| <a href="/admin/permissions/destroy/'+row['id']+'" class="X-Small btn-xs text-primary ">删除</a>'
                            return caozuo;
                        }
                    }
                ]
